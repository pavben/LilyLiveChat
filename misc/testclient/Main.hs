...
main = do
  ...
  putStrLn "Connected"
  case createMessage 1 [LE.decodeUtf8 (LC8.pack "2"), LE.decodeUtf8 (LC8.pack "Angry Bear"), LE.decodeUtf8 (LC8.pack "#111111"), LE.decodeUtf8 (LC8.pack "images/angry-bear.png")] of
    Just x -> sendAll s x

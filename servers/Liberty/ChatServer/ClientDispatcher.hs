...
runClientDispatcher :: SiteMapTVar -> SiteDataSaverChan -> IO ()
runClientDispatcher siteMapTVar siteDataSaverChan = do
  ...
  where
    ...
    handleException ex = do
      ...
      runClientDispatcher siteMapTVar siteDataSaverChan
